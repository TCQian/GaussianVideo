...
CHECKPOINT_DIR_PATH="/home/e/e0407638/github/GaussianVideo/checkpoints_LOD/${DATA_NAME}/ProgressiveGaussianVideo_i${TRAIN_ITERATIONS}_g${NUM_POINTS}_f${NUM_FRAMES}_s${START_FRAME}"
CHECKPOINT_DIR_PATH_QUANT="/home/e/e0407638/github/GaussianVideo/checkpoints_quant_LOD/${DATA_NAME}/ProgressiveGaussianVideo_i${TRAIN_ITERATIONS}_g${NUM_POINTS}_f${NUM_FRAMES}_s${START_FRAME}"
