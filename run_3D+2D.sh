...
CHECKPOINT_QUANR_DIR_PATH="/home/e/e0407638/github/GaussianVideo/checkpoints_quant/${DATA_NAME}/${MODEL_NAME_3D}_i${TRAIN_ITERATIONS_3D}_g${NUM_POINTS_3D}_${MODEL_NAME_2D}_i${TRAIN_ITERATIONS_2D}_g${NUM_POINTS_2D}_f${NUM_FRAMES}_s${START_FRAME}/"
