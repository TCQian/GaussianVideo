...
project_gaussians_video_forward = _make_lazy_cuda_func("project_gaussians_video_forward")
project_gaussians_video_backward = _make_lazy_cuda_func("project_gaussians_video_backward")
get_tile_bin_edges_video = _make_lazy_cuda_func("get_tile_bin_edges_video")
map_gaussian_to_intersects_video = _make_lazy_cuda_func("map_gaussian_to_intersects_video")
rasterize_sum_forward_video = _make_lazy_cuda_func("rasterize_sum_forward_video")
rasterize_sum_backward_video = _make_lazy_cuda_func("rasterize_sum_backward_video")